...
def main():
    ...
    # From Replay Buffer to LeRobotSingleDataset

    ## Buffer requirements:
        # Accept images and stitch together as video
        # Maintain different stages or cycle
            # remember in which stage, the data was added.
        # inherit from LeRobotSingleDataset, and track global episode index or trajectory_id. 
        # Retrive data with get_step_data()
        # add data online from simulation 
